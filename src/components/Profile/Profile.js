...
class Profile extends Component {
  ...
  onFormChange = (event) => {
    ...
    if(target.name === 'user-name') this.setState({name: target.value});
    else if(target.name === 'user-age') this.setState({age: target.value});
    else if(target.name === 'user-pet') this.setState({pet: target.value});
  }
